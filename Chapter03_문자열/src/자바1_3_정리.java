 ...
 *           a++ , ++a
 *           ---   ---
 *                 증가가 먼저 나중에 다른 연산에 포함시킴
 *         이항연산자 (+,-,*,/,%,=>,==,<=,<,>,&&,||,=,+=,-=)
 *             1. 모든 연산자 같은 데이터형만 연산이 가능
 *                10+10.5
 *                -- 10.0으로 변환 => 10.0+10.5 ==> 20.5
 *                + : 산술 / 문자열 결합
 *                          -------
 *                          +
 *                          concat("aaa")
 ...
 *                   * 산술규칙
 *                       = 같은 데이터형만 연산이 가능
 *                       = int 이하(byte,short,char) => 결과값은 int
 ...
 *                      ==> 숫자 , boolean : == , !=
 *                      
 *                      &&(직렬연산자 => 양쪽의 조건이 모두 true일때) 
 *                      ||(병렬연산자 => 한쪽의 조건이 true일때)
 *                      *** &&연산자는 범위 포함 , 기간 범위
 *                          조건 && 조건
 *                          ---
