 ...
 *      | 통합 : 스프링
 *      
 *             method(int a,int b,int c ....) => method(int[] arr)
 *             method(int a,String s,double b) => method(A a)
 ...
 *                |    |
 *                ------
 *         => 왼쪽에 있는 데이터형이 크거나 같다 => 권장사항(같은 데이터형으로 써라)
 *         => 통계 / 회계
 *         
 *        메소드 제작
 *        1) 반복이 많은 경우
