 ...
 *      
 *      메소드 => 사용할때 (호출)
 *              호출이 되면 메소드를 처음부터 수행 => 다시 호출된 위치로 복귀
 *              
 *      메소드 구성요소
