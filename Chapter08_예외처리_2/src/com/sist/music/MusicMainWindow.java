...
/*
 *    extends = 상속 (클래스가 가지고 있는 모든 변수와 메소드를 가져온다)
 *              --- 생성자 , static , 초기화 블록
 *    => 객체지향
 ...
 *   		추상 클래스			인터페이스
 *   -------------------------------------
 *   형식		abstract class	public interface 인터페이스 명
 *   		-------- 꼭 붙여야함
 *   -------------------------------------
 *   멤버변수	일반 멤버변수		상수
 *   -------------------------------------
...
implements ActionListener
{
	 ...
	 *    접근지정어
	 *   
	 *    => 클래스 : 다른 클래스에서 사용이 돼야함 (public)
	 *    => 생성자 : 다른 클래스에서 사용이 돼야함 (public)
	 *    => 멤버변수 : 자신의 클래스에서만 사용 (private)
	 *       -----
	 *       기본형 / 클래스 / 배열
	...
	{
		JPanel p=new JPanel();
		p.setLayout(new GridLayout(1,7)); // 1줄/7개 출력
